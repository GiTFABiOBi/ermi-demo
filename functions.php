...
function genesis_sample_enqueue_scripts_styles() {
	...
	/** FABiO'scripts */
	wp_enqueue_script('demo-js-bs', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.7/dist/js/bootstrap.bundle.min.js', array('jquery'), '', true);
    wp_enqueue_style('demo-css-bs', 'https://cdn.jsdelivr.net/npm/bootstrap@5.3.7/dist/css/bootstrap.min.css');

	wp_enqueue_script('my-script', get_stylesheet_directory_uri() . '/inc/myscript.js', array( 'jquery' ));
	
	wp_enqueue_style(
		'demo-hamburgers',
		get_home_url().'/wp-content/themes/genesis-sample/dist/hamburgers.min.css',
		[],
		null
	);
	/** END FABiO'scripts */
...
add_filter( 'genesis_attr_entry-content', 'add_custom_title' );
function add_custom_title($attributes)
{
